    ...
    return(
        ...
        <Navigation_Signin />
            <div className='carscontent'>
                <p className='hometosedan'>Home - SUVs Car </p>
                <p className='carsheading'>SUVs Cars</p>
                <p className='carssubheading'>The top SUV cars in India include Mahindra XUV700 (₹ 12.49 Lakh),
                 Hyundai Creta (₹ 10.16 Lakh) and MG Astor (₹ 9.78 Lakh). To see the latest price in your city, offers, variants, specifications,
                 pictures, mileage and reviews of the best SUV cars.</p>
            </div>
